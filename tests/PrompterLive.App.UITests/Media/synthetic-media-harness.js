(() => {
    ...
    const defaultGroupId = "prompterlive-browser-group";
    const primaryCameraGroupId = "prompterlive-camera-a";
    const secondaryCameraGroupId = "prompterlive-camera-b";
    const primaryMicrophoneGroupId = "prompterlive-mic-a";
