...
internal static class EditorMonacoInteropMethodNames
{
    public const string JSImportMethodName = "import";
    public const string ModulePath = "./_content/PrompterOne.Shared/editor/editor-monaco.js";
    public const string InitializeEditor = "initializeEditor";
    public const string SyncEditorState = "syncEditorState";
    public const string GetSelectionState = "getSelectionState";
    public const string SetSelection = "setSelection";
    public const string SetFindMatches = "setFindMatches";
