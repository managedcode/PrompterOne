...
public static partial class UiTestIds
{
    public static class Settings
    {
        ...
        public const string AboutResourcesCard = "settings-about-resources-card";
        ...
        public const string AppearanceInterfaceCard = "settings-appearance-interface-card";
        public const string AppearanceTeleprompterCard = "settings-appearance-teleprompter-card";
        public const string AppearanceThemeCard = "settings-appearance-theme-card";
        ...
        public const string Sidebar = "settings-sidebar";
        public const string Title = "settings-title";
        public const string RecordingAudioBitrate = "settings-recording-audio-bitrate";
        public const string RecordingAudioCard = "settings-recording-audio-card";
        public const string RecordingAutoRecord = "settings-recording-auto-record";
        public const string RecordingGeneralCard = "settings-recording-general-card";
        ...
        public const string RecordingVideoCard = "settings-recording-video-card";
